# --------- Flask settings
SERVER_HOST = 'https://func-app-exam-2.azurewebsites.net' # Update this for the appropriate front-end website when up
SERVER_PORT = 5000
...
API_URL = "https://func-app-exam-2.azurewebsites.net/api/"
